...
|---|---|
| `server_cpp` | C++-based option pricing server |
| `server_py` | Python-based option pricing server |
| `client/pricer_client.py` | Publishes option pricing requests |
| `client/report_builder.py` | Reads the database generated by the client and produces a pricing latency report |
| `docker-compose-instance-per-node-2.yml` | Docker Swarm configuration used for the performance test |
